    ...
    public class ApplicationDbContext(DbContextOptions options) : IdentityDbContext<ApplicationUser>(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Projecty>().HasData(
                ...
                new Projecty { ProjectId = 3, ProjectName = "Project Gamma", ConstructionType = "Residential", Status = "Planning", Budget = 250000, StartDate = new DateTime(2024, 3, 1), Description = "Planning phase", Address = "789 Pine St", Neighborhood = "Suburban", City = "CityC", State = "StateC", PostalCode = "34567", Country = "CountryC", TotalArea = 180.0m, NumberOfRooms = 3, NumberOfBathrooms = 2, ClientId = 3 },
                new Projecty { ProjectId = 4, ProjectName = "Project Delta", ConstructionType = "Commercial", Status = "In Progress", Budget = 750000, StartDate = new DateTime(2024, 4, 1), Description = "Office building item", Address = "101 Maple St", Neighborhood = "Tech Park", City = "CityD", State = "StateD", PostalCode = "45678", Country = "CountryD", TotalArea = 350.0m, NumberOfRooms = 8, NumberOfBathrooms = 4, ClientId = 4 },
                ...
                new Projecty { ProjectId = 7, ProjectName = "Project Eta", ConstructionType = "Residential", Status = "In Progress", Budget = 600000, StartDate = new DateTime(2024, 7, 1), Description = "Luxury apartments", Address = "404 Fir St", Neighborhood = "Uptown", City = "CityG", State = "StateG", PostalCode = "78901", Country = "CountryG", TotalArea = 350.0m, NumberOfRooms = 6, NumberOfBathrooms = 4, ClientId = 7 },
                ...
                new Projecty { ProjectId = 11, ProjectName = "Project Lambda", ConstructionType = "Residential", Status = "Completed", Budget = 350000, StartDate = new DateTime(2023, 10, 1), EndDate = new DateTime(2024, 4, 1), Description = "Townhouse", Address = "808 Willow St", Neighborhood = "Historic District", City = "CityK", State = "StateK", PostalCode = "12346", Country = "CountryK", TotalArea = 200.0m, NumberOfRooms = 4, NumberOfBathrooms = 2, ClientId = 11 },
                ...
                new Projecty { ProjectId = 14, ProjectName = "Project Xi", ConstructionType = "Commercial", Status = "Completed", Budget = 1100000, StartDate = new DateTime(2023, 12, 1), EndDate = new DateTime(2024, 5, 1), Description = "Hotel", Address = "1111 Fir St", Neighborhood = "Resort Area", City = "CityN", State = "StateN", PostalCode = "45679", Country = "CountryN", TotalArea = 600.0m, NumberOfRooms = 50, NumberOfBathrooms = 30, ClientId = 14 },
                new Projecty { ProjectId = 15, ProjectName = "Project Omicron", ConstructionType = "Residential", Status = "In Progress", Budget = 500000, StartDate = new DateTime(2024, 10, 1), Description = "Family home", Address = "1212 Elm St", Neighborhood = "Suburban", City = "CityO", State = "StateO", PostalCode = "56780", Country = "CountryO", TotalArea = 270.0m, NumberOfRooms = 5, NumberOfBathrooms = 3, ClientId = 15 }
            );
